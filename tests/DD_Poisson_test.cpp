...
//			MultithreadInfo::set_thread_limit(1);
			...
			std::cout << "POISSON-LDG COUPLING" << std::endl;
			...
			Mixed_table.evaluate_convergence_rates(
																	"Phi", 
			...
			LDG_table.evaluate_convergence_rates(
																	"u", 
																	ConvergenceTable::reduction_rate_log2);
			...
			std::string mixed_file = "Coupled_Mixed_Deg_";
			mixed_file += oss.str();
			mixed_file += ".tex";
			...
			std::string LDG_file = "Coupled_Poisson_LDG_Deg_";
			LDG_file += oss.str();
			LDG_file += ".tex";
